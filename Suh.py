...
# Original written By HUNNY

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'HUNNY'

__copyright = 'All rights reserved . Copyright  HUNNY'

CorrectUsername = 'HUNNY'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            os.system('xdg-open https://www.facebook.com/UmErFarOoQChOuDhry')
...
\033[1;91m Author      :  HUNNY

\033[1;91m FACEBOOK  :  https://www.facebook.com/UmErFarOoQChOuDhry

\033[1;91m VERSOIN   : 0.9.2
